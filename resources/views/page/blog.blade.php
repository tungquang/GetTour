...
<aside id="colorlib-hero">
  <div class="flexslider">
    <ul class="slides">
      <li style="background-image: url({{asset('/storage/cover-img-2.jpg')}});">
      ...
      <div class="col-md-8">
        <div class="wrap-division">
          <article class="animate-box">
            <div class="blog-img" style="background-image: url({{asset('/storage/blog-1.jpg')}});"></div>
            <div class="desc">
              <div class="meta">
                <p>
          ...
          <article class="animate-box">
            <div class="blog-img" style="background-image: url({{asset('/storage/blog-2.jpg')}});"></div>
            <div class="desc">
              <div class="meta">
                <p>
                  <span>Feb 24, 2018 </span>
          ...
          <article class="animate-box">
            <div class="blog-img" style="background-image: url({{asset('/storage/blog-3.jpg')}});"></div>
            <div class="desc">
              <div class="meta">
                <p>
                  <span>Feb 24, 2018 </span>
          ...
          <div class="side animate-box">
            ...
            <div class="blog-entry-side">
              <a href="blog.html" class="blog-post">
                <span class="img" style="background-image: url({{asset('/storage/blog-3.jpg')}});"></span>
                <div class="desc">
            ...
            <div class="blog-entry-side">
              <a href="blog.html" class="blog-post">
                <span class="img" style="background-image: url({{asset('/storage/blog-2.jpg')}});"></span>
                <div class="desc">
                  <span class="date">Feb 24, 2018</span>
