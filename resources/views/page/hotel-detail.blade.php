              ...
              <div class="row">
                  ...
                  <div class="room-wrap">
                    <div class="row">
                      <div class="col-md-6 col-sm-6">
                        <div class="room-img" style="background-image: url({{asset('/storage/room-1.jpg')}});"></div>
                      </div>
                      <div class="col-md-6 col-sm-6">
                        <div class="desc">
                          <h2>Family Room</h2>
                ...
                <div class="col-md-12 animate-box">
                  <div class="room-wrap">
                    <div class="row">
                      <div class="col-md-6 col-sm-6">
                        <div class="room-img" style="background-image: url({{asset('/storage/room-2.jpg')}});"></div>
                      </div>
                      <div class="col-md-6 col-sm-6">
                        <div class="desc">
                          <h2>Luxury Room</h2>
                ...
                <div class="col-md-12 animate-box">
                  <div class="room-wrap">
                    <div class="row">
                      <div class="col-md-6 col-sm-6">
                        <div class="room-img" style="background-image: url({{asset('/storage/room-3.jpg')}});"></div>
                      </div>
                      <div class="col-md-6 col-sm-6">
                        <div class="desc">
                          <h2>Double Room</h2>
                ...
                <div class="col-md-12 animate-box">
                  <div class="room-wrap">
                    <div class="row">
                      <div class="col-md-6 col-sm-6">
                        <div class="room-img" style="background-image: url({{asset('/storage/room-4.jpg')}});"></div>
                      </div>
                      <div class="col-md-6 col-sm-6">
                        <div class="desc">
                          <h2>Suite Room</h2>
                ...
                <div class="col-md-12 animate-box">
                  <div class="room-wrap">
                    <div class="row">
                      <div class="col-md-6 col-sm-6">
                        <div class="room-img" style="background-image: url({{asset('/storage/room-5.jpg')}});"></div>
                      </div>
                      <div class="col-md-6 col-sm-6">
                        <div class="desc">
                ...
                <div class="col-md-12 animate-box">
                  <div class="room-wrap">
                    <div class="row">
                      <div class="col-md-6 col-sm-6">
                        <div class="room-img" style="background-image: url({{asset('/storage/room-6.jpg')}});"></div>
                      </div>
                      <div class="col-md-6 col-sm-6">
                        <div class="desc">
